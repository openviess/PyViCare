...
class PyViCareServiceTest(unittest.TestCase):
    ...
    def test_getProperty(self):
        ...
        self.oauth_mock.get.assert_called_once_with(
            '/features/installations/[id]/gateways/[serial]/devices/0/features/someprop')
    ...
    def test_setProperty_object(self):
        ...
        self.oauth_mock.post.assert_called_once_with(
            '/features/installations/[id]/gateways/[serial]/devices/0/features/someprop/commands/doaction', '{"name": "abc"}')

    def test_setProperty_string(self):
        self.service.setProperty(self.accessor, "someprop", "doaction", '{}')
        self.oauth_mock.post.assert_called_once_with(
            '/features/installations/[id]/gateways/[serial]/devices/0/features/someprop/commands/doaction', '{}')
